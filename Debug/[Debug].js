...
export default class Debug {
	...
	/**@private @type {string} Contiene el nombre del archivo `.vlog`. */
	Archivo = null;
	...
	ID = null;
	/**@private @type {string} Contiene la ruta del archivo `.vlog`. */
	Ruta = null;
	/**@type {FS.WriteStream} Contiene el Stream del archivo `.vlog`.*/
	Stream = null;
	/**
	...
	constructor(Ruta, ID, Consola = null) {
		...
		this.Fecha = new Date;
		this.Archivo = `[${ID}] ${this.Fecha.getHours()}-${this.Fecha.getMinutes()}-${this.Fecha.getSeconds()}-${this.Fecha.getMilliseconds()}.vlog`;

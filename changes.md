...
- Mail: accessible from (vortez/Beta/Mail.js)
- JwtManager: accessible from (vortez/Beta/JwtManager.js)

## 3.7
> [!IMPORTANT]
> **Vortez** has been migrated to TypeScript.
...
### 3.5.3
  **Fixed**
  ...
  - The Folder rule exposing the global NetFeez-Labs content (`/NetFeez-Labs:Global`) is now working.
...
js import { Beta } from 'vortez'; const Mail = Beta.Mail; const JsonWT = Beta.JsonWT;
...
### 3.3.2
  - Fixed an error in JsonWT. This caused an exception that terminated the execution of NetFeez-Labs.Vortez instead of returning false to indicate that the json was not valid.

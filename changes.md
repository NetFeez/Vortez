...
- Mail: acceso desde (vortez/Beta/Mail.js)
- JwtManager: acceso desde (vortez/Beta/JwtManager.js)

## 3.7
> [!IMPORTANT]
> **Vortez** ha sido movido al lenguaje TypeScript
...
### 3.5.3
  **Correcciones**
  ...
  - La regla Folder que exponía el contenido global de NetFeez-Labs esta en funcionamiento /NetFeez-Labs:Global
...
### 3.3.2
  - Se corrigió un error en JsonWT, este se ocasionaba una excepción que finalizaba la ejecución de NetFeez-Labs.Vortez en lugar de enviar false para indicar que el json no era valido

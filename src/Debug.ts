...
export class Debug {
    ...
    private getFilePath(): string {
		...
		const file = `[${this.id}] - ${this.startDate.hour}.${this.startDate.minute}.${this.startDate.second}.${this.startDate.miliSecond}.vlog`;
	...
	private getStream(): WriteStream {
		...
		stream.write('/*+----------------------------+*/\n');
		stream.write('/*| NetFeez-Labs/Debug by NetFeez |*/\n');
		stream.write('/*|     Use NetFeez-Labs ReadDebug     |*/\n');
		stream.write('/*+----------------------------+*/\n');

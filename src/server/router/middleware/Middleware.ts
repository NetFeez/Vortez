...
export namespace Middleware {
    ...
    export namespace action {
        ...
        export type ws = (request: Request, client: Websocket.WebsocketSSInit, next: next, state: State) => Promise<void>;
    }
    export namespace errorAction {
        ...
        export type ws = (error: unknown, request: Request, client: Websocket.WebsocketSSInit, next: next, state: State) => Promise<void>;
    }

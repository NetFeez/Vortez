...
> ```
<br/><br/>
Una ves tengas Vortez en tu proyecto debes importar el artchivo `Vortez.js`<br/>
...
- Si no tienes esta propiedad usa:
  ```js
  const Vortez = require('./Vortez/Vortez.js').default;
  ```
<br/><br/>
## Servidot HTTP
...
- Pasandole Puerto y Host
  ```js
  const Servidor = new Vortez(80, 'MiDominio.com');
  ```
<br/><br/>
## Servidor HTTPS
> [!NOTE]
...
```js
const Servidor = new Vortez(80, null, {
...
<br/><br/>
## Agregar enrutadores
En **`Vortez`** existen 4 clases de enrutador:<br/>
<table>
  <tr>
    <th>Tipo</th>
    <th>Descripción</th>
